...
class IncomeFilterBar extends ConsumerStatefulWidget {
  const IncomeFilterBar({super.key});

  @override
  ConsumerState<IncomeFilterBar> createState() => _IncomeFilterBarState();
}

class _IncomeFilterBarState extends ConsumerState<IncomeFilterBar> {
      ...
      children: [
        Padding(
          ...
          child: AppSearchField(
            hintText: 'আয় অনুসন্ধান করুন...',
            onChanged: (v) => ref.read(incomeSearchProvider.notifier).state = v,
          ),
        ),
        AppSpacing.boxSM,
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              AppSpacing.boxSM,
              _buildFilterChip('গৃহীত', 'completed'),
              AppSpacing.boxSM,
  ...
  Widget _buildFilterChip(String label, String? status) {
    ...
    return FilterChip(
      ...
      onSelected: (_) {
        ...
        ref.read(incomeStatusFilterProvider.notifier).state = _selectedStatus;
        ref.read(incomeRefreshProvider.notifier).state++;
      },
